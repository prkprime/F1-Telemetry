...
public enum DriverId {
    ...
    /**
     * Get a DriverId from its numeric value
     *
     * @param id numeric identifier
     * @return corresponding DriverId or ONLINE_PLAYER if not found
     */
    public static DriverId fromId(int id) {
        for (DriverId driverId : values()) {
            if (driverId.id == id) {
                return driverId;
            }
        }
