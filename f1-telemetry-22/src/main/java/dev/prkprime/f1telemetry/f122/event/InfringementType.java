...
/**
 * Enum for F1 22 infringement types
 */
@Getter
...
public enum InfringementType {
    ...
    /**
     * Get an InfringementType from its numeric value
     *
     * @param id numeric identifier
     * @return corresponding InfringementType
     */
    public static InfringementType fromId(int id) {
        for (InfringementType infringementType : values()) {
            if (infringementType.id == id) {
                return infringementType;
            }
        }
        throw new IllegalArgumentException("Invalid infringement type ID: " + id);
    }
}